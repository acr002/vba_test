...
' メインメニュー：業務コードの行列
    gcode_row = 3: gcode_col = 8

' メインメニュー：作業ドライブの行列
    gdrive_row = 3: gdrive_col = 23

' メインメニュー：初期設定済みメッセージ出力先行列
    initial_row = 6: initial_col = 32

' 設定画面：先頭パラメータの行列
    setup_row = 3: setup_col = 1
    
' 設定画面：入力データ列番号の行列
    incol_row = 3: incol_col = 3
End Sub

Sub Finishing_Mcs2017()
'--------------------------------------------------------------------------------------------------'
'　終了処理・各オブジェクトの参照を解除　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　'
'--------------------------------------------------------------------------------------------------'
'　作成者　　　菊崎　洋　　　　　　　　　　　　　　　　　　　　　　　　　　　　作成日　2017.04.10　'
